...
<!--
  ...
  For constitution compliance checklists, generated items MUST verify:
  - Personal-use scope and v1 MVP boundaries
  - Separate market/language handling for English, Japanese, and Chinese data
  - Complete card, variant, sealed product, and individual ownership modeling
  - SGD-only display with source currency and exchange-rate auditability
  - Append-only price and portfolio valuation snapshots
